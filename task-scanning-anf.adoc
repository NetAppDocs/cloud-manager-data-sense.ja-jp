...
Azure NetApp Files ボリュームをスキャンする前に、 https://docs.netapp.com/us-en/cloud-manager-azure-netapp-files/task-manage-anf.html["構成を検出するには、 Cloud Manager が設定されている必要があります"^]。
...
https://docs.netapp.com/us-en/cloud-manager-azure-netapp-files/task-manage-anf.html["Cloud Manager で Azure NetApp Files システムを検出する方法をご覧ください"^]。
